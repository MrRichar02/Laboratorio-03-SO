...
- **Ricardo Medina Herrera**  
    - C.C: 1036251162
    - ricardo.medinah@udea.edu.co
- **Santiago Villegas Naranjo**
    - C.C: 1001479227
    - santiago.villegasn@udea.edu.co
...
Algunos puntos requerían realizar consultas o tenían términos que no se conocían; en estos casos utilizamos IA para ayudarnos a tener una idea de con qué estamos tratando a un alto nivel. De esta forma teníamos un contexto que nos facilitó luego profundizar los temas indicados y comprenderlos de una mejor manera.

Luego de realizar cálculos tipo traducción de direcciones, se compartía el proceso de traducción con la IA para que esta señalara errores en los procesos; de esta forma, la IA no nos daba la respuesta directamente sino que nos ayudaba a llegar a ella por nuestra propia cuenta, corrigiendo y explicando los errores cometidos.

Nos ayudó a comprender las escalas de las unidades que estábamos usando en los distintos ejercicios comparadas con las que se suelen manejar en entornos actuales, lo que resultó muy útil para realizar las comparaciones y generar conclusiones sobre la insuficiencia de los tamaños vistos en los ejercicios para entornos reales.

# Conclusiones

1. El laboratorio permitió comprender cómo el sistema operativo organiza y protege el espacio de memoria de los procesos mediante mecanismos como segmentación, paginación y traducción de direcciones.
2. A través del uso de herramientas como Valgrind, se identificaron y corrigieron errores clásicos de memoria, fortaleciendo las buenas prácticas en programación en C y el manejo seguro del heap.
3. Los experimentos realizados evidenciaron la importancia del aislamiento entre procesos y el papel de la memoria virtual para garantizar estabilidad y seguridad en el sistema.
4. El análisis de TLB, fragmentación y estrategias de asignación mostró cómo las decisiones de gestión de memoria impactan directamente el rendimiento y la eficiencia de los sistemas modernos.
5. La práctica permitió relacionar los conceptos teóricos vistos en clase con implementaciones reales y simulaciones, facilitando una comprensión más profunda del funcionamiento interno de la memoria en sistemas operativos.
